      ...
      <main className="flex w-full flex-col items-center justify-center dark:text-light">
        <Layout className="pt-0">
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            ...
            <div className="col-span-2 flex flex-col items-end justify-between gap-4 xl:col-span-8 xl:flex-row xl:items-center md:order-3">
              <div className="flex flex-col items-end gap-2 justify-center xl:items-center">
              ...
              <div className="flex flex-col items-end gap-1 justify-center xl:items-center">
                <span className="inline-block text-7xl font-bold md:text-6xl sm:text-5xl xs:text-4xl">
