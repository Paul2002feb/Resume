          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
              ...
              <p className="font-medium text-m">
                Hey There 👋 I&apos;m Paul! a recent UVA grad with a degree in Computer Science and a minor in Technology Entrepreneurship. I love creating things that make life easier or more fun—whether that’s through product management, software engineering, or just brainstorming new ideas with a team. There’s something exciting about taking an idea and turning it into something real that people can actually use.
              </p>
