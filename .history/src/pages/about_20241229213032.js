        ...
        <Layout className="pt-0">
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
              ...
              <p className="my-4 font-medium text-m">
              When I’m not working on tech stuff, I like to keep busy with things that help me recharge. You’ll usually find me playing soccer or basketball, messing around on my guitar (still working on that one hit song), or tracking down the best food spots wherever I am. I’m also always up for trying something new—whether it’s a new hobby, a new restaurant, or a random road trip.
