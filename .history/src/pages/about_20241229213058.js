        ...
        <Layout className="pt-0">
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
              ...
              I’m big on collaboration and making work enjoyable. I genuinely believe the best projects happen when people bring positive energy and humor to the table, even when things get tough. If you’re someone who enjoys tackling challenges and having fun along the way, we’ll get along great!
