        ...
        <Layout className="pt-0">
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
              ...
              You’ll usually find me playing soccer or basketball, messing around on my guitar , or tracking down the best food spots wherever I am. I’m also always up for trying something new—whether it’s a new hobby, a new restaurant, or a random road trip.
