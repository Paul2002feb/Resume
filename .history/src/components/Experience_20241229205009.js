      ...
      <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full ">
        ...
        <ul className="w-full flex flex-col items-start justify-between  ml-4 xs:ml-4">
          ...
          <Details
            ...
            address="Bangkok, TH"
            work="
            • ISpearheaded feature ideation process for CC10 Guidewire Management Software, facilitating the creation of a product requirement document (PRD) to establish a shared understanding between the client and the team.            "
            work2="
